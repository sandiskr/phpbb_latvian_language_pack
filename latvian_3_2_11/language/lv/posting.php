...
$lang = array_merge($lang, array(
	...
	'ADD_POLL_EXPLAIN' => 'Ja nevēlies pievienot aptauju savai sarakstei, atstāj laukus tukšus.',
	'ALREADY_DELETED' => 'Piedod, šī ziņa jau ir izdzēsta.',
	'ATTACH_COMMENT_NO_EMOJIS'	=> 'The attachment comment contains forbidden characters (Emoji).',
	'ATTACH_DISK_FULL' => 'Nepietiek diska vietas, lai pievienotu un publicētu šo pielikumu.',
	'ATTACH_QUOTA_REACHED' => 'Ir izsmelta atļautā diska vieta šī foruma datiem.',
	'ATTACH_SIG' => 'Pievieno parakstu (parakstus var mainīt caur LKP)',

	'BBCODE_A_HELP'				=> 'Inline uploaded attachment: [attachment=]filename.ext[/attachment]',
	'BBCODE_B_HELP' => 'Izcelts teksts: [b]teksts[/b]',
	'BBCODE_C_HELP' => 'Koda attēlojums: [code]kods[/code]',
	'BBCODE_D_HELP'				=> 'Flash: [flash=width,height]http://url[/flash]',
	'BBCODE_F_HELP' => 'Teksta izmērs: [size=85]mazs teksts[/size]',
	'BBCODE_IS_OFF' => '%sBBCode%s ir <em>IZSLĒGTS</em>',
	'BBCODE_IS_ON' => '%sBBCode%s ir <em>IESLĒGTS</em>',
	'BBCODE_I_HELP' => 'Slīpraksts: [i]teksts[/i]',
	'BBCODE_L_HELP' => 'Saraksts: [list][*]teksts[/list]',
	'BBCODE_LISTITEM_HELP' => 'Saraksta elements: [*]teksts',
	'BBCODE_O_HELP' => 'Kārtots saraksts: e.g. [list=1][*]Pirmais punkts[/list] vai [list=a][*]Punkts a[/list]',
	'BBCODE_P_HELP' => 'Ievietot attēlu: [img]http://image_url[/img]',
	'BBCODE_Q_HELP' => 'Citāts: [quote]teksts[/quote]',
	'BBCODE_S_HELP' => 'Fonta krāsa: [color=red]teksts[/color] vai [color=#FF0000]teksts[/color]',
	'BBCODE_U_HELP' => 'Pasvītrojuma teksts: [u]teksts[/u]',
	'BBCODE_W_HELP' => 'Ievietot URL: [url]http://url[/url] vai [url=http://url]adrese[/url]',
	...
	'CHANGE_TOPIC_TO' => 'Mainīt ziņojuma tipu uz',
	...
	'DELETE_POST_WARN' => 'Izdzēst šo ziņu',
	...
	'DISABLE_BBCODE' => 'Atspējot BBCode',
	'DISABLE_MAGIC_URL' => 'Neparsēt automātiski tīmekļa vietņu adreses',
	'DISABLE_SMILIES' => 'Atspējot emocijzīmes',
	...
	'DRAFT_SAVED' => 'Melnraksts sekmīgi saglabāts.',
	...
	'FONT_COLOR' => 'Teksta krāsa',
	'FONT_COLOR_HIDE' => 'Noslēpt teksta krāsu',
	'FONT_HUGE' => 'Milzīgs',
	'FONT_LARGE' => 'Liels',
	'FONT_NORMAL' => 'Normāls',
	...
	'IMAGES_ARE_OFF' => '[img] ir <em>IZSLĒGTS</em>',
	'IMAGES_ARE_ON' => '[img] ir <em>IESLĒGTS</em>',
	...
	'SMILIES'					=> 'Smilies',
	'SMILIES_ARE_OFF' => 'Emocijzīmes ir <em>IZSLĒGTAS</em>',
	'SMILIES_ARE_ON' => 'Emocijzīmes ir <em>IESLĒGTS</em>',
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Sticky/Announcement/Global time limit',
	'STICK_TOPIC_FOR' => 'Piespraust tematu par',
	...
	'TOPIC_BUMPED' => 'Temats sekmīgi aktualizēts.',

	'UNAUTHORISED_BBCODE'		=> 'You cannot use certain BBCodes: %s.',
	'UNGLOBALISE_EXPLAIN' => 'Lai pārslēgtu šo tematu atpakaļ uz normālu no globāla, nepieciešams izvēlēties forumu kurā šo tēmu attēlot.',
	...
	'USER_CANNOT_BUMP' => 'Šajā forumā Tev nav atļauts aktualizēt tēmas.',
	'USER_CANNOT_DELETE' => 'Tev nav atļauts dzēst rakstus šajā forumā.',
	'USER_CANNOT_EDIT' => 'Tev nav atļauts rediģēt rakstus šajā forumā.',
	'USER_CANNOT_REPLY' => 'Tev nav atļauts atbildēt šajā forumā.',
	'USER_CANNOT_FORUM_POST'	=> 'You are not able to do posting operations on this forum due to the forum type not supporting it.',

	'VIEW_MESSAGE' => '%sApskatīt jūsu iesniegto ziņu%s',
	'VIEW_PRIVATE_MESSAGE' => '%sApskatīt jūsu iesniegto privāto ziņu%s',

	'WRONG_FILESIZE' => 'Datne ir pārāk liela, atļautais izmērs ir ne vairāk kā %1$d %2$s.',
	'WRONG_SIZE' => 'Attēlam jābūt vismaz %1$s platam, %2$s augstam un ne vairāk kā %3$s platam un %4$s augstam. Iesniegtais attēls ir %5$s plats un %6$s augsts.',
));
