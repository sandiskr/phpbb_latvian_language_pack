...
$lang = array_merge($lang, array(
	...
	'ACP'							=> 'Administratora Kontroles Panelis',
	'ACP_SHORT'						=> 'AKP',
	'ACTIVE'						=> 'aktīvs',
	...
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'Jūsu darbība neizdevās, jo notika kļūda ar pieprasījumu un tika atgriezta nekorekta atbilde.',
	'ALLOWED'						=> 'Atļauts',
	'ALL_FILES'						=> 'All files',
	'ALL_FORUMS'					=> 'Visi forumi',
	'ALL_MESSAGES'					=> 'Visas ziņas',
	'ALL_POSTS'						=> 'All posts',
	'ALL_TIMES'						=> 'Visi laiki ir <span title="%2$s">%1$s</span>',
	...
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'Attēls, ko vēlējāties pievienot, nav derīgs.',
	'AUTHOR'						=> 'Autors',
	...
	'BROWSING_FORUM'		=> 'Pārlūko šo tematu: %1$s',
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> 'Tematu skata: %2$s un %1$d viesis',
		2	=> 'Tematu skata: %2$s un %1$d viesi',
	),
	'BUTTON_EDIT'			=> 'Labot',
	'BUTTON_FORUM_LOCKED'	=> 'Bloķēts',
	'BUTTON_NEW_TOPIC'		=> 'Jauns temats',
	'BUTTON_PM'				=> 'Privātā ziņa',
	'BUTTON_PM_FORWARD'		=> 'Pārsūtīt',
	'BUTTON_PM_NEW'			=> 'Jauna privātā ziņa',
	'BUTTON_PM_REPLY'		=> 'Atbildēt',
	'BUTTON_PM_REPLY_ALL'	=> 'Atbildēt visiem',
	'BUTTON_POST_REPLY'		=> 'Rakstīt atbildi',
	'BUTTON_QUOTE'			=> 'Citēt',
	'BUTTON_TOPIC_LOCKED'	=> 'Bloķēts',
	'BYTES'					=> 'Baiti',
	'BYTES_SHORT'			=> 'B',

	'CANCEL'				=> 'Atcelt',
	'CHANGE'				=> 'Mainīt',
	'CHANGE_FONT_SIZE'		=> 'Izmainīt teksta izmēru',
	...
	'COOKIE_CONSENT_OK'		=> 'Sapratu!',
	'COOKIE_CONSENT_HREF'	=> 'http://cookiesandyou.com',
	'COOKIES_DELETED'		=> 'Visas Foruma sīkdatnes veiksmīgi izdzēstas.',
	'CURRENT_TIME'			=> 'Pašreizējais laiks %s',

	'DAY'					=> 'Diena',
	'DAYS'					=> 'Dienas',
	'DELETE'				=> 'Dzēst',
	'DELETE_ALL'			=> 'Dzēst visu',
	'DELETE_COOKIES'		=> 'Izdzēst visas Foruma sīkdatnes',
	'DELETE_MARKED'			=> 'Dzēst atzīmēto',
	...
	'EDIT_POST'							=> 'Labot ierakstu',
	'ELLIPSIS'							=>	'…',
	'EMAIL'								=> 'Epasts', // Short form for EMAIL_ADDRESS
	...
	'ERR_UNABLE_TO_LOGIN'				=> 'Norādītais lietotājvārds vai parole nav pareizi.',
	...
	'FACEBOOK'				=> 'Facebook',
	'FAQ'					=> 'BUJ',
	'FAQ_EXPLAIN'			=> 'Biežāk Uzdotie Jautājumi',
	...
	'FIND_USERNAME'			=> 'Meklēt lietotāju',
	'FOLDER'				=> 'Folder',
	'FORGOT_PASS'			=> 'Aizmirsta parole',
	'FORM_INVALID'			=> 'The submitted form was invalid. Try submitting again.',
	'FORUM'					=> 'Forums',
	'FORUMS'				=> 'Forums',
	'FORUMS_MARKED'			=> 'Forums have been marked read.',
	'FORUM_CAT'				=> 'Forum category',
	'FORUM_INDEX'			=> 'Foruma sākums',
	'FORUM_LINK'			=> 'Foruma saite',
	...
	'GO'						=> 'Aiziet!',
	'GOOGLEPLUS'				=> 'Google+',
	'GOTO_FIRST_POST'			=> 'Uz pirmo ziņu',
	'GOTO_LAST_POST'			=> 'Uz pēdējo ziņu',
	...
	'GUEST_USERS_ONLINE'		=> array(
		1	=> 'Viens viesis skatās forumu',
		2	=> '%d viesi skatās forumu',
	),
	...
	'G_BOTS'					=> 'Roboti',
	'G_GUESTS'					=> 'Viesi',
	'G_REGISTERED'				=> 'Reģistrēti lietotāji',
	'G_REGISTERED_COPPA'		=> 'Reģistrētie COPPA lietotāji',
	'G_GLOBAL_MODERATORS'		=> 'Globālie moderatori',
	'G_NEWLY_REGISTERED'		=> 'Nesen reģistrējušies lietotāji',
	...
	'HIDE_ME'						=> 'Noslēpt citiem manu skatīšanās statusu šajā sesijā',
	'HOURS'							=> 'Stundas',
	'HOME'							=> 'Sākums',
	...
	'JUMP_TO'				=> 'Pāriet uz',
	'JUMP_TO_PAGE'			=> 'Pāriet uz lapu',
	'JUMP_TO_PAGE_CLICK'	=> 'Noklikšķināt, lai pārietu uz lapu…',
	...
	'LAST_VISIT'						=> 'Pēdējo reizi apmeklēts',
	...
	'LOGIN_REQUIRED'					=> 'Nepieciešams autorizēties, lai veiktu šo darbību.',
	'LOGOUT'							=> 'Atteikšanās',
	'LOGOUT_USER'						=> 'Iziet no profila [ %s ]',
	...
	'MARK_READ'				=> 'Mark read',
	'MARK_SUBFORUMS_READ'	=> 'Atzīmēt apakštematus kā lasītus',
	'MB'					=> 'MB',
	'MIB'					=> 'MiB',
	...
	'MERGE'					=> 'Merge',
	'MERGE_POSTS'			=> 'Pārvietot ierakstus',
	'MERGE_TOPIC'			=> 'Apvienot tematus',
	'MESSAGE'				=> 'Ziņa',
	'MESSAGES'				=> 'Ziņas',
	...
	'NOTIFICATION_POST'					=> array(
		1	=> '<strong>Atbilde</strong> no %1$s tematā:',
	),
	'NOTIFICATION_POST_APPROVED'		=> '<strong>Ieraksts apstiprināts</strong>:',
	'NOTIFICATION_POST_DISAPPROVED'		=> '<strong>Ieraksts nav apstiprināts</strong>:',
	'NOTIFICATION_POST_IN_QUEUE'		=> 'Pieprasījums no %1$s <strong>apstiprināt ierakstu</strong>:',
	'NOTIFICATION_QUOTE'				=> array(
		1	=> 'Lietotājs %1$s <strong>citēja</strong> tematā:',
	),
	...
	'NOTIFICATION_TOPIC'				=> '<strong>Jauns temats</strong> no %1$s:',
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>Temats apstiprināta</strong>:',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '<strong>Temats nav apstiprināta</strong>:',
	'NOTIFICATION_TOPIC_IN_QUEUE'		=> 'Pieprasījums no %1$s <strong>apstiprināt jaunu tematu</strong>:',
	...
	'NO_ACCESS_ATTACHMENT'		=> 'Tev nav atļauts piekļūt šim failam.',
	...
	'NO_TOPICS'					=> 'Šajā forumā nav ne tematu, ne ziņu',
	...
	'POST_DELETED_ACTION'	=> 'Dzēsta ziņa:',
	'POST_DELETED'			=> 'Šī ziņa tika izdzēsta.',
	...
	'PREVIOUS'				=> 'Iepriekšējā',		// Used in pagination
	'PREVIOUS_STEP'			=> 'Iepriekšējais',
	'PRIVACY'				=> 'Privacy policy',
	'PRIVATE_MESSAGE'		=> 'Privāta ziņa',
	'PRIVATE_MESSAGES'		=> 'Privātās ziņas',
	'PRIVATE_MESSAGING'		=> 'Private messaging',
	'PROFILE'				=> 'Vadības panelis',

	'QUICK_LINKS'			=> 'Tiešās saites',
	...
	'REASON'					=> 'Reason',
	'RECORD_ONLINE_USERS'		=> 'Lielākais vienlaicīgais apmeklētāju skaits <strong>%1$s</strong> notika %2$s',
	'REDIRECT'					=> 'Redirect',
	...
	'REG_USERS_ONLINE'			=> array(
		1	=> 'Pašlaik %1$d reģistrēts lietotājs un %2$s tiešsaistē',
		2	=> 'Pašlaik %1$d reģistrēti lietotāji un %2$s tiešsaistē',
	),
	...
	'RETURN_TO'					=> 'Atpakaļ uz “%s”',
	'RETURN_TO_INDEX'			=> 'Atpakaļ uz Foruma sākumu',
	'FEED'						=> 'Feed',
	'FEED_NEWS'					=> 'News',
	'FEED_TOPICS_ACTIVE'		=> 'Aktīvie temati',
	'FEED_TOPICS_NEW'			=> 'Jaunie temati',
	'RULES_ATTACH_CAN'			=> 'Jūs <strong>drīkstat</strong> izlikt pielikumus šajā forumā',
	'RULES_ATTACH_CANNOT'		=> 'Jūs <strong>nedrīkstat</strong> izlikt pielikumus šajā forumā',
	'RULES_DELETE_CAN'			=> 'Jūs <strong>drīkstat</strong> dzēst savas ziņas šajā forumā',
	'RULES_DELETE_CANNOT'		=> 'Jūs <strong>nedrīkstat</strong> dzēst savas ziņas šajā forumā',
	'RULES_DOWNLOAD_CAN'		=> 'Jūs <strong>drīkstat</strong> lejupielādēt pielikumus šajā forumā',
	'RULES_DOWNLOAD_CANNOT'		=> 'Jūs <strong>nedrīkstat</strong> lejupielādēt pielikumus šajā forumā',
	'RULES_EDIT_CAN'			=> 'Jūs <strong>drīkstat</strong> labot savas ziņas šajā forumā',
	'RULES_EDIT_CANNOT'			=> 'Jūs <strong>nedrīkstat</strong> labot savas ziņas šajā forumā',
	'RULES_LOCK_CAN'			=> 'Jūs <strong>drīkstat</strong> bloķēt savus tematus šajā forumā',
	'RULES_LOCK_CANNOT'			=> 'Jūs <strong>nedrīkstat</strong> bloķēt savus tematus šajā forumā',
	'RULES_POST_CAN'			=> 'Jūs <strong>drīkstat</strong> rakstīt jaunas ziņas šajā forumā',
	'RULES_POST_CANNOT'			=> 'Jūs <strong>nedrīkstat</strong> rakstīt jaunas ziņas šajā forumā',
	'RULES_REPLY_CAN'			=> 'Jūs <strong>drīkstat</strong> atbildēt uz tematiem šajā forumā',
	'RULES_REPLY_CANNOT'		=> 'Jūs <strong>nedrīkstat</strong> atbildēt uz tematiem šajā forumā',
	'RULES_VOTE_CAN'			=> 'Jūs <strong>drīkstat</strong> balsot aptaujās šajā forumā',
	'RULES_VOTE_CANNOT'			=> 'Jūs <strong>nedrīkstat</strong> balsot aptaujās šajā forumā',

	'SEARCH'					=> 'Meklēt',
	'SEARCH_MINI'				=> 'Meklēt…',
	'SEARCH_ADV'				=> 'Detalizētā meklēšana',
	'SEARCH_ADV_EXPLAIN'		=> 'Apskatīt detalizētās meklēšana iespējas',
	'SEARCH_KEYWORDS'			=> 'Meklēt pēc atslēgas vārdiem',
	'SEARCHING_FORUMS'			=> 'Searching forums',
	'SEARCH_ACTIVE_TOPICS'		=> 'Aktīvie temati',
	'SEARCH_FOR'				=> 'Search for',
	'SEARCH_FORUM'				=> 'Meklēt forumā…',
	'SEARCH_NEW'				=> 'Jaunās ziņas',
	'SEARCH_POSTS_BY'			=> 'Meklēt pēc autora',
	'SEARCH_SELF'				=> 'Jūsu ziņas',
	'SEARCH_TOPIC'				=> 'Meklēt tēmā…',
	'SEARCH_UNANSWERED'			=> 'Neatbildētie temati',
	'SEARCH_UNREAD'				=> 'Nelasītās ziņas',
	'SEARCH_USER_POSTS'			=> 'Meklēt lietotāja ziņas',
	'SECONDS'					=> 'Sekundes',
	'SEE_ALL'					=> 'See All',
	'SELECT'					=> 'Select',
	...
	'SEND_EMAIL'				=> 'Nosūtīt e-pastu',				// Used for submit buttons
	'SEND_EMAIL_USER'			=> 'Nosūtīt e-pastu to %s',
	'SEND_PRIVATE_MESSAGE'		=> 'Nosūtīt privātu ziņu',
	...
	'SORT_BY'					=> 'Kārtot pēc',
	'SORT_DIRECTION'			=> 'Virziens',
	'SORT_JOINED'				=> 'Pievienošanās datuma',
	'SORT_LOCATION'				=> 'Vietas',
	'SORT_OPTIONS'				=> 'Attēlošanas un kārtošanas iespējas',
	'SORT_RANK'					=> 'Rangs',
	'SORT_POSTS'				=> 'Ziņojumus',
	'SORT_TOPIC_TITLE'			=> 'Temata nosaukums',
	'SORT_USERNAME'				=> 'Lietotāja vārds',
	'SPLIT_TOPIC'				=> 'Sadalīt tematu',
	...
	'TOPIC_REVIEW'		=> 'Temata apskate',
	'TOPIC_TITLE'		=> 'Temata nosaukums',
	...
	'TOTAL_POSTS'		=> 'Kopā ieraksti',
	'TOTAL_POSTS_COUNT'	=> array(
		2	=> 'Kopā forumā ir <strong>%d</strong> ieraksti',
	),
	'TOPIC_REPORTED'	=> 'This topic has been reported',
	'TOTAL_TOPICS'		=> array(
		2	=> '<strong>%d</strong> temati',
	),
	'TOTAL_USERS'		=> array(
		2	=> '<strong>%d</strong> reģistrēti lietotāji',
	),
	...
	'UNREAD_POST'			=> 'Nelasīta ziņa',
	'UNREAD_POSTS'			=> 'Nelasītas ziņas',
	...
	'VIEW_LATEST_POST'			=> 'Apskatīt pēdējo ziņu',
	'VIEW_NEWEST_POST'			=> 'Rādīt pirmo nelasīto ziņu',
	'VIEW_NOTES'				=> 'Rādīt lietotāja piezīmes',
	'VIEW_ONLINE_TIMES'			=> array(
		1	=> 'aprēķins veikts pēc pēdējās %d minūtes aktivitātes',
		2	=> 'aprēķins veikts pēc pēdējo %d minūšu aktivitātes',
	),
	'VIEW_TOPIC'				=> 'Rādīt tematu',
	...
	'WEBSITE'			=> 'Website',
	'WHOIS'				=> 'Whois',
	'WHO_IS_ONLINE'		=> 'Pašlaik pieslēgušies',
	'WRONG_PASSWORD'	=> 'Ievadīta nepareiza parole.',
	...
	'YES'				=> 'Jā',
	'YOU_LAST_VISIT'	=> 'Pēdējoreiz apmeklēji: %s',
