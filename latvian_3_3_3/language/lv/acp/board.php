...
$lang = array_merge($lang, array(
	'ACP_BOARD_SETTINGS_EXPLAIN'	=> 'Šeit tiek nodefinētas pamata operācijas forumā, dodot nosaukumu, aprakstu, pieregulē noklusētos stilus, laika zonas, utt.',
	'BOARD_INDEX_TEXT'				=> 'Sākumlapas navigācijas nosaukums',
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Šis teksts attēlosies foruma navigācijas ceļā kā foruma sākumlapas apzīmējums. Ja nekas netiks norādīts, tad noklusēti rādīsies “Foruma sākums”.',
	'BOARD_STYLE'					=> 'Foruma stils',
	'CUSTOM_DATEFORMAT'				=> 'Īpaši pielāgot laika formātu…',
	'DEFAULT_DATE_FORMAT'			=> 'Datuma formāts',
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Pielāgojamais datuma formāts ir tas pats, kas PHP <code><a href="https://secure.php.net/manual/function.date.php">date()</a></code> funkcijai.',
	'DEFAULT_LANGUAGE'				=> 'Noklusētā valoda',
	'DEFAULT_STYLE'					=> 'Noklusētais stils',
	'DEFAULT_STYLE_EXPLAIN'			=> 'Foruma izskata stils, ko visi jaunie lietotāji redzēs standartā pēc noklusējuma.',
	'DISABLE_BOARD'					=> 'Izslēgt forumu',
	'DISABLE_BOARD_EXPLAIN'			=> 'Ar šo iestatījumu viss forums kļūs nepieejams lietotājiem, kas nav administratori vai moderatori. Ja vēlaties, varat pievienot īsu (255 simbolu) paziņojumu, ko attēlot visiem apmeklētājiem.',
	'DISPLAY_LAST_SUBJECT'			=> 'Attēlot pēdējo pievienoto sarakstes tēmu forumu nosaukumu sarakstā',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Pēdējās pievienotās ziņas tēmas virsraksts kopā ar saiti uz šo ziņu tiks attēlots forumu izvēles sarakstā. Ja kāda sarunu telpa ir slēgta ar paroli, tad neautorizēti lietotāji neredzēs šo virsrakstu un saiti.',
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Attēlot neapstiprinātos ziņu ierakstus to autoram',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Ziņu ieraksti, kuriem vēl nepieciešams apstiprinājums, ir redzami to autoram. Neattiecas uz foruma viesu ierakstiem.',
	'GUEST_STYLE'					=> 'Viesu stils',
	'GUEST_STYLE_EXPLAIN'			=> 'Foruma izskata stils, ko redzēs neautorizētie lietotāji.',
	'OVERRIDE_STYLE'				=> 'Lietotāju stila pārrakstīšana',
	'OVERRIDE_STYLE_EXPLAIN'		=> 'Aizstāj visu lietotāju izvēlēto un viesu foruma izskata stilu ar to, kas norādīts "Noklusētais stils".',
	'SITE_DESC'						=> 'Lapas apraksts',
	'SITE_HOME_TEXT'				=> 'Sākuma navigācijas teksts',
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Šis teksts attēlosies kā saite uz iepriekš norādīto galveno lapas adresi foruma navigācijā. Ja netiks norādīts, tad noklusēti rādīsies “Sākums”.',
	'SITE_HOME_URL'					=> 'Galvenā lapas adrese (URL)',
	'SITE_HOME_URL_EXPLAIN'			=> 'Nav obligāti jānorāda, bet ja tiks norādīts, tad šī adrese tiks automātiski pielikta priekšā visām navigācijas adresēm, atvērsies klikšķinot uz foruma logo attēla tā vietā, lai izsauktu noklusēto sākuma lapas failu. Nepieciešams norādīt pilnu adresi jeb <samp>http://www.phpbb.com</samp>.',
	'SITE_NAME'						=> 'Lapas virsraksts',
	'SYSTEM_TIMEZONE'				=> 'Viesu laika zona',
	'SYSTEM_TIMEZONE_EXPLAIN'			=> 'Laika zona, ko izmantos attēlojot laiku lietotājiem, kas nebūs autorizējušies (viesi, roboti). Autorizējušies lietotāji laika zonu uzstāda reģistrējoties un var mainīt savā kontroles panelī.',
	'WARNINGS_EXPIRE'				=> 'Brīdinājuma ilgums',
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Dienu skaits, pēc kura izsniegtie brīdinājumi pazudīs no lietotāja profila. Uzstādot 0 kā vērtību, visi brīdinājumi paliek mūžīgi.',
));
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION'				=> 'Lietotāju aktivizācija',
	'ACC_ACTIVATION_EXPLAIN'		=> 'Ar šo nosaka vai lietotājiem ir tūlītēja pieeja foruma paneļiem vai arī nepieciešams apstiprinājums. Var arī pilnībā izslēgt jaunu lietotāju reģistrāciju. <em>“Board-wide email” must be enabled in order to use user or admin activation.</em>',
...
$lang = array_merge($lang, array(
	...
	'ALL'							=> 'All',
	'ALLOW_AUTOLOGIN'				=> 'Atļaut "Atcērēties mani" autorizēšanos',
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Nosaka vai lietotājiem tiek piedāvāta izvēlne "Atcerēties mani" kad tie mēģina autorizēties.',
